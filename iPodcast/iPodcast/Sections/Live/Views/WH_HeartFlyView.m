...
@implementation WH_HeartFlyView
...
- (void)animateInView:(UIView *)view {
    ...
    NSTimeInterval totlaAnimationDuration = 6;
    ...
    // Bloom
    [UIView animateWithDuration:0.5f delay:0.0f usingSpringWithDamping:0.6 initialSpringVelocity:0.8 options:UIViewAnimationOptionCurveEaseOut animations:^{
    ...
    [UIView animateWithDuration:totlaAnimationDuration animations:^{
    ...
    // randomsize x and y for control points
    ...
    keyFrameAnimation.duration = totlaAnimationDuration + endPoint.y / viewHeight;
...
- (void)drawHeartInRect:(CGRect)rect {
    ...
    CGPoint topLeftCurveStart = CGPointMake(drawingPadding, floorf(CGRectGetHeight(rect) / 2.4));
